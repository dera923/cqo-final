...
@click.option(
    "--eps", type=float, default=None, help="Adopted epsilon; if None, compute empirically"
)
...
@click.option(
    "--features", required=True, help="Comma-separated feature names for SMD (e.g. X0,X1,X2)"
)
